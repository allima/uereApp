...
import br.edu.ifmg.polo.pedidovenda.service.CadastroPedidoService;
...
public class CadastroPedidoBean implements Serializable {
	...
	public void salvar() {
		...
		Coordenadas coord;
		GoogleGeocodingService googleCoordenadas = new GoogleGeocodingService();
		coord = googleCoordenadas.obterCoordenadas(this.pedido.getEnderecoEntrega());
		...
		if (coord == null) {
			...
			this.pedido.getEnderecoEntrega().setLatitude(coord.getLatitude());
			this.pedido.getEnderecoEntrega().setLongitude(coord.getLongitude());
