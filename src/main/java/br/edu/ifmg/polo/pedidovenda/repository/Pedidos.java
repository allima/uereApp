...
import br.edu.ifmg.polo.pedidovenda.model.vo.DataValor;
...
public class Pedidos implements Serializable {
	...
	public List<Pedido> getListaPedidosVendedor(Long id_vendedor) {
		List<Pedido> aux = new ArrayList<>();

		try {
			aux = (ArrayList<Pedido>) this.manager
					.createQuery("from Pedido where vendedor_id = :id_vendedor ", Pedido.class)
					.setParameter("id_vendedor", id_vendedor).getResultList();
			return aux;
